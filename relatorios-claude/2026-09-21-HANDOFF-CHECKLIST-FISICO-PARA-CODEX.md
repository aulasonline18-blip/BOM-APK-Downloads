...
| | SHA | branch | status |
|---|---|---|---|
| **BOM (app) main** | `2adc48e` | main | pushado; último APK release instalado no tablet, SHA-256 `8f207e48a11d16fcca3589cf6e1db076f42adb143e7c192d2ace2cca3f011402` |
| **Servidor-BOM main** | `6885043` | main | pushado, `git status` limpo |
| **Servidor de produção real (droplet)** | `6885043` | — | rodando, `bom-api.service` active, health 200 |

Observação: o servidor de produção foi atualizado para o commit exato `6885043` durante a correção do replay econômico após restart; os releases anteriores `72c7d20` e `519f3c8` permanecem disponíveis para rollback.
