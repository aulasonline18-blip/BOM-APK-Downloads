...
| Recuperação | OK_PRODUCTION | 1e7b20b | 5f7e0cf | produção real no Samsung: `Start recovery` somente na entrada; Q1→feedback→Continue→próxima questão direto e mais uma transição interna repetida sem cartão de preparação; APK `d5c8c9f8...` |
