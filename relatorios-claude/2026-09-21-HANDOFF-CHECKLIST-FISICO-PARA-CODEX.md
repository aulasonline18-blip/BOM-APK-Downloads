...
| **Servidor-BOM main** | `72c7d20` | main | pushado, `git status` limpo |
| **Servidor de produção real (droplet)** | `72c7d20` | — | rodando, `bom-api.service` active, health 200 |

Observação: o servidor de produção foi atualizado para o commit exato `72c7d20` durante a correção física do Nivelamento/Placement; o release anterior `519f3c8` permanece disponível para rollback.
