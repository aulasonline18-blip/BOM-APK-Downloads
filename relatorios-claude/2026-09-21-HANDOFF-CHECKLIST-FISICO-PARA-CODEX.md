...
| Placement (dentro de CG-1) | RETEST_REQUIRED | — | — | nenhuma prova física de placement especificamente dentro de currículo 60-150 itens; CG-1 só foi testado retomando aula já iniciada (item 2/60) |
...
| Rename | RETEST_REQUIRED | 356fa93 (parcial) | 5f7e0cf | funciona em aula recém-criada (Atualização 7), mas falha silenciosamente e de forma reproduzível em aulas com histórico de múltiplas sessões de teste — ver Seção H, causa raiz candidata não confirmada ao vivo |
